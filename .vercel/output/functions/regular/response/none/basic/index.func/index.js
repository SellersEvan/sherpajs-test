...
// /Users/sellerew/Desktop/libraries/SherpaJS/tests/servers/pass-primary/routes/regular/response/none/basic/index.ts
var basic_exports = {};
...
var segments = [{ "name": "regular", "isDynamic": false }, { "name": "response", "isDynamic": false }, { "name": "none", "isDynamic": false }, { "name": "basic", "isDynamic": false }];
async function index(nativeRequest, event) {
  let req = await RequestVercel(nativeRequest, segments);
  let res = await Handler(basic_exports, view, context, req);
